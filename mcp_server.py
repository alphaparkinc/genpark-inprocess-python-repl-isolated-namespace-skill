"""
MCP Server for genpark-inprocess-python-repl-isolated-namespace-skill
...
def handle_request(req):
    ...
    if method == "tools/list":
                ...
                "tools": [
                    {
                        ...
                        "description": "Execute Python code in an isolated REPL namespace with captured stdout.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "code": {"type": "string"}
        ...
        if tool_name == "run_python_code":
            res = repl.execute_code(args["code"])
            return {
                "jsonrpc": "2.0",
                "id": req_id,
                "result": {
